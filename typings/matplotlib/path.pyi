...
class Path:
    ...
    def iter_segments(self, transform=..., remove_nans=..., clip=..., snap=..., stroke_width=..., simplify=..., curves=..., sketch=...): # -> Generator[tuple[Any | NDArray[Any], Unknown], Any, None]:
        """
    ...
    def iter_bezier(self, **kwargs): # -> Generator[tuple[BezierSegment, Unknown], Any, None]:
        """
    ...
    def to_polygons(self, transform=..., width=..., height=..., closed_only=...): # -> list[Unknown] | list[list[Unknown | Any] | Unknown | NDArray[Any]]:
        """
