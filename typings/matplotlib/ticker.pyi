...
class LogLocator(Locator):
    ...
    def view_limits(self, vmin, vmax): # -> tuple[Unknown | float | Any | int, Unknown | Any | Literal[10]]:
        """Try to choose the view limits intelligently."""
        ...
    
    def nonsingular(self, vmin, vmax): # -> tuple[Unknown | float | int, Unknown | Literal[10]]:
        ...
