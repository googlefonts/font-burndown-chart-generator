...
class Colorbar:
    ...
    def __init__(self, ax, mappable=..., *, cmap=..., norm=..., alpha=..., values=..., boundaries=..., orientation=..., ticklocation=..., extend=..., spacing=..., ticks=..., format=..., drawedges=..., filled=..., extendfrac=..., extendrect=..., label=..., location=...) -> None:
        ...
...
@_docstring.interpd
def make_axes(parents, location=..., orientation=..., fraction=..., shrink=..., aspect=..., **kwargs): # -> tuple[Unknown | Any, dict[str, Unknown]]:
    """
...
@_docstring.interpd
def make_axes_gridspec(parent, *, location=..., orientation=..., fraction=..., shrink=..., aspect=..., **kwargs): # -> tuple[Unknown, dict[str, Unknown]]:
    """
    Create an `~.axes.Axes` suitable for a colorbar.
